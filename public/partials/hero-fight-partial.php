    <div class="flex flex-row">
        <div class="flex flex-col">
            ...
            <?php if ($hero instanceof Guerrier) { ?>
                <p id="hero-rage-value" class=" text-[20px] text-white font-family-oswald font-bold">Rage : <?= $hero->getRage() ?></p>
            <?php } ?>
            <?php if ($hero instanceof Magician) { ?>
                <p id="hero-mana-value" class=" text-[20px] text-white font-family-oswald font-bold">Mana : <?= $hero->getMana() ?></p>
            <?php } ?>
        </div>
        <div class="heroCharacter shrink-0">
            <div class="flex flex-col items-center justify-center mb-2">
                ...
                <p id="hero-hp-value" class=" text-[20px] text-white font-family-oswald font-bold">HP : <?= $hero->getHp() ?></p>
            </div>
